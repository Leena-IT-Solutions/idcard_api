<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl shadow-gray-200/50 dark:shadow-none sm:rounded-3xl border border-gray-100 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __("Manage deployment updates and run Artisan console utility commands.") }}</p>
                    </div>
            ...
            <!-- Git Update Card -->
            <div x-data="gitUpdater()" x-init="init()" class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl shadow-gray-200/50 dark:shadow-none sm:rounded-3xl border border-gray-100 dark:border-gray-700 p-6 sm:p-8">
                ...
                <div x-show="showConfirmModal" class="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4" style="display: none;">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl transform transition-all w-full max-w-md z-50 border border-gray-100 dark:border-gray-700">
                        <div class="p-6 sm:p-8">
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-300 mb-6 leading-relaxed" x-text="confirmDescription"></p>
