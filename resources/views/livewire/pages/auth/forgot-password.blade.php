...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function sendPasswordResetLink(): void
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Password reset email dispatch failed', [
                'email' => $this->email,
                'error' => $e->getMessage()
            ]);
            $this->addError('email', 'Unable to send password reset email (' . $e->getMessage() . '). Please verify email gateway configuration or contact administrator.');
            return;
        }
