...
new class extends Component
{
    ...
    public function exportSelected()
    {
        ...
        return $this->redirect(route('exports.index', ['students' => implode(',', $this->selectedStudentIds)]), navigate: true);
    }
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/50 dark:shadow-none">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-2.5 w-full sm:w-auto flex-wrap">
            ...
            <a href="{{ route('exports.index') }}" wire:navigate class="inline-flex items-center justify-center gap-1.5 w-full sm:w-auto px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-wider rounded-xl transition shadow cursor-pointer">
    ...
    @if(count($selectedStudentIds) > 0)
        <div class="fixed bottom-6 inset-x-0 z-40 flex justify-center px-4">
            <div class="bg-gray-900 dark:bg-black text-white px-6 py-3.5 rounded-3xl shadow-2xl border border-gray-700 flex items-center gap-4 flex-wrap max-w-2xl w-full justify-between backdrop-blur-md">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                    <button type="button" wire:click="exportSelected" class="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition cursor-pointer shadow-sm flex items-center gap-1.5">
                                            ...
                                            <div class="flex-1 overflow-y-auto min-h-0 space-y-3 py-2 pr-1">
                                                ...
                                                <div x-show="step === 'crop'" class="space-y-2">
                                                    ...
                                                    <div class="relative w-full h-[320px] sm:h-[360px] bg-gray-950 rounded-2xl overflow-hidden flex items-center justify-center border border-gray-800 shadow-inner">
                                                        <template x-if="isLoadingPhoto">
                                                            <div class="absolute inset-0 z-20 flex flex-col items-center justify-center bg-gray-950/90 backdrop-blur-sm gap-3">
                                                                <svg class="animate-spin h-8 w-8 text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                                                </svg>
                                                                <span class="text-xs font-bold text-gray-300">Loading photo...</span>
                                                            </div>
                                                        </template>
