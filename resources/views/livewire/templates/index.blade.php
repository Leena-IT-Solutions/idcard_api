...
<div class="space-y-8">
    ...
    <!-- Header & Action Bar -->
    <div class="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 text-gray-900 dark:text-white rounded-3xl p-6 md:p-8 flex flex-wrap items-center justify-between gap-6 shadow-md dark:shadow-2xl relative overflow-hidden backdrop-blur-xl">
        ...
        <div class="relative z-10 flex items-center space-x-3">
            <button type="button" wire:click="$set('isImportModalOpen', true)" class="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 dark:border-slate-700/60 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center shadow-sm">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-sm rounded-2xl p-4">
