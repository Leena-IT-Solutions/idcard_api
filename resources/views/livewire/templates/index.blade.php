...
<div class="space-y-8">
    @if(session()->has('message'))
        <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 dark:bg-emerald-500/10 dark:border-emerald-500/20 dark:text-emerald-400 p-4 rounded-2xl flex items-center justify-between text-sm font-semibold shadow-lg backdrop-blur-md">
    ...
    <!-- Header & Action Bar -->
    <div class="bg-white border border-gray-200 text-gray-900 shadow-xl dark:bg-gradient-to-r dark:from-slate-900 dark:via-slate-900/90 dark:to-indigo-950/40 dark:border-slate-800 dark:text-white rounded-3xl p-6 md:p-8 flex flex-wrap items-center justify-between gap-6 relative overflow-hidden backdrop-blur-xl">
        ...
        <div class="relative z-10 flex items-center space-x-3">
            <button type="button" wire:click="$set('isImportModalOpen', true)" class="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-200 dark:bg-slate-800/80 dark:hover:bg-slate-700 dark:text-slate-200 dark:border-slate-700/60 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center shadow-sm">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 bg-white border border-gray-200 shadow-sm dark:bg-slate-900 dark:border-slate-800 rounded-2xl p-4 backdrop-blur-md">
        <div class="flex items-center space-x-2 overflow-x-auto pb-1 md:pb-0">
            <button type="button" wire:click="$set('selectedCategory', 'all')" class="px-4 py-2 rounded-xl text-xs font-bold transition {{ $selectedCategory === 'all' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-600/20' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 hover:text-gray-900 dark:bg-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white' }}">
                All Templates
            </button>
            <button type="button" wire:click="$set('selectedCategory', 'landscape')" class="px-4 py-2 rounded-xl text-xs font-bold transition {{ $selectedCategory === 'landscape' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-600/20' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 hover:text-gray-900 dark:bg-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white' }}">
                Landscape 📐
            </button>
            <button type="button" wire:click="$set('selectedCategory', 'portrait')" class="px-4 py-2 rounded-xl text-xs font-bold transition {{ $selectedCategory === 'portrait' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-600/20' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 hover:text-gray-900 dark:bg-slate-950 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white' }}">
                Portrait 📱
            </button>
        </div>

        <div class="relative min-w-[240px]">
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search templates by name..." class="w-full bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 dark:bg-slate-950 dark:border-slate-800 dark:text-white dark:placeholder-slate-500 rounded-xl pl-9 pr-4 py-2 text-xs font-bold focus:outline-none focus:border-indigo-500 transition">
    ...
    @if($schoolTemplates->isNotEmpty())
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                ...
                <span class="text-xs text-gray-600 dark:text-slate-400 font-bold bg-gray-100 border border-gray-200 dark:bg-slate-900 dark:border-slate-800 px-3 py-1 rounded-full">{{ $schoolTemplates->count() }} Custom Template(s)</span>
            </div>
                    ...
                    <div class="bg-white border border-gray-200 hover:border-indigo-500/50 text-gray-900 shadow-lg hover:shadow-xl dark:bg-slate-900 dark:border-slate-800 dark:hover:border-indigo-500/50 dark:text-white rounded-3xl p-5 transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
                        <div>
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span class="text-[10px] text-gray-600 dark:text-slate-400 font-extrabold uppercase tracking-wider bg-gray-100 border border-gray-200 dark:bg-slate-950 dark:border-slate-800 px-2 py-0.5 rounded-md">
                            ...
                            <div class="relative w-full bg-gray-50 border border-gray-200 rounded-2xl p-4 mb-4 flex items-center justify-center min-h-[220px] overflow-hidden group-hover:border-indigo-500/40 transition-all duration-300 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] dark:bg-slate-950/80 dark:border-slate-800/80 dark:bg-[radial-gradient(#334155_1px,transparent_1px)] [background-size:16px_16px]">
                        ...
                        <div class="space-y-2 pt-3 border-t border-gray-100 dark:border-slate-800/80">
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <button type="button" wire:click="openAssignModal({{ $st->id }}, true)" class="py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 dark:border-slate-700/60 rounded-xl text-xs font-extrabold transition flex items-center justify-center">
                            ...
                            <div class="flex items-center justify-between space-x-2 pt-1">
                                <button type="button" wire:click="exportJson({{ $st->id }}, true)" class="flex-1 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-gray-900 border border-gray-200 dark:bg-slate-950 dark:hover:bg-slate-800 dark:text-slate-400 dark:hover:text-white dark:border-slate-800 rounded-xl text-[11px] font-semibold transition flex items-center justify-center">
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            ...
            <span class="text-xs text-gray-600 dark:text-slate-400 font-bold bg-gray-100 border border-gray-200 dark:bg-slate-900 dark:border-slate-800 px-3 py-1 rounded-full">Standard Presets</span>
        </div>
                ...
                <div class="bg-white border border-gray-200 hover:border-indigo-500/50 text-gray-900 shadow-lg hover:shadow-xl dark:bg-slate-900 dark:border-slate-800 dark:hover:border-indigo-500/50 dark:text-white rounded-3xl p-5 transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
                    ...
                    <div class="space-y-2 pt-3 border-t border-gray-100 dark:border-slate-800/80">
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <button type="button" wire:click="openAssignModal('{{ $tpl->id }}', false)" class="py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 dark:border-slate-700/60 rounded-xl text-xs font-extrabold transition flex items-center justify-center">
                                <svg class="w-3.5 h-3.5 mr-1.5 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                                </svg>
                                Assign Grade
                        ...
                        <button type="button" wire:click="exportJson('{{ $tpl->id }}', false)" class="w-full text-center py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-gray-900 border border-gray-200 dark:bg-slate-950 dark:hover:bg-slate-800 dark:text-slate-400 dark:hover:text-white dark:border-slate-800 rounded-xl text-[11px] font-semibold transition flex items-center justify-center">
                            <svg class="w-3.5 h-3.5 mr-1 text-gray-500 dark:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                            </svg>
                            Export JSON Layout
    ...
    @if($isPreviewModalOpen && $selectedTemplateForPreview)
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 dark:bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
            <div class="bg-white border border-gray-200 text-gray-900 shadow-2xl dark:bg-slate-900 dark:border-slate-800 dark:text-white rounded-3xl max-w-2xl w-full p-6 space-y-6">
                ...
                <div class="bg-gray-100 border border-gray-200 dark:bg-slate-950 dark:border-slate-800 rounded-2xl p-6 flex items-center justify-center min-h-[320px] overflow-hidden bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] dark:bg-[radial-gradient(#334155_1px,transparent_1px)] [background-size:16px_16px]">
                ...
                <div class="flex items-center justify-between border-t border-gray-200 dark:border-slate-800 pt-4">
                    <button type="button" wire:click="exportJson({{ $selectedTemplateForPreview->id }}, {{ $isSchoolTemplate ? 'true' : 'false' }})" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 dark:border-slate-700/60 rounded-xl text-xs font-bold transition flex items-center">
    ...
    @if($isAssignModalOpen && $selectedTemplateForAssign)
        ...
        @endphp
        <div class="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 dark:bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
            <div class="bg-white border border-gray-200 text-gray-900 shadow-2xl dark:bg-slate-900 dark:border-slate-800 dark:text-white rounded-3xl max-w-lg w-full p-6 space-y-5">
                <div class="flex items-center justify-between border-b border-gray-200 dark:border-slate-800 pb-4">
                    <div>
                ...
                @if($assignSuccessMessage)
                    <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 dark:bg-emerald-950/90 dark:border-emerald-500/60 dark:text-emerald-100 p-3.5 rounded-2xl flex items-center justify-between text-xs font-bold shadow-lg">
                        <div class="flex items-center space-x-2">
                        ...
                        <button type="button" wire:click="$set('assignSuccessMessage', null)" class="text-emerald-600 dark:text-emerald-300 hover:text-gray-900 dark:hover:text-white transition">&times;</button>
                    </div>
                @endif

                <!-- Option 1: School Default -->
                <div class="bg-gray-50 border border-gray-200 dark:bg-slate-950 dark:border-slate-800 rounded-2xl p-4 flex items-center justify-between">
                    <div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="max-h-60 overflow-y-auto space-y-2 pr-1">
                        @foreach($schoolGrades as $g)
                            ...
                            @endphp
                            <div class="bg-gray-50 border border-gray-200 dark:bg-slate-950/70 dark:border-slate-800/80 rounded-2xl p-3 flex items-center justify-between">
                                <div>
                                ...
                                @else
                                    <button type="button" wire:click="assignToGrade({{ $g->id }}, '{{ $selectedTemplateForAssign->id }}', {{ $isSchoolTemplate ? 'true' : 'false' }})" class="px-3.5 py-1.5 bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 rounded-xl text-xs font-semibold transition active:scale-95">
                ...
                <div class="flex justify-end pt-2">
                    <button type="button" wire:click="closeAssignModal" class="px-5 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold transition">
                        Done / Close
                    </button>
                </div>
            </div>
    ...
    @if($isImportModalOpen)
        <div class="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 dark:bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
            <div class="bg-white border border-gray-200 text-gray-900 shadow-2xl dark:bg-slate-900 dark:border-slate-800 dark:text-white rounded-3xl max-w-md w-full p-6 space-y-5">
                <div class="flex items-center justify-between border-b border-gray-200 dark:border-slate-800 pb-4">
                ...
                <form wire:submit.prevent="importJsonTemplate" class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="importName" placeholder="e.g. Custom Science ID Card" class="w-full bg-gray-50 border border-gray-200 text-gray-900 dark:bg-slate-950 dark:border-slate-800 dark:text-white rounded-xl px-3.5 py-2.5 text-xs font-bold focus:outline-none focus:border-indigo-500 transition">
                    ...
                    <div>
                        ...
                        <input type="file" wire:model="importFile" accept=".json" class="w-full bg-gray-50 border border-gray-200 text-gray-900 dark:bg-slate-950 dark:border-slate-800 dark:text-white rounded-xl px-3.5 py-2.5 text-xs font-bold focus:outline-none focus:border-indigo-500 transition">
                        @error('importFile') <span class="text-xs text-red-500 dark:text-red-400 mt-1 block">{{ $message }}</span> @enderror
                    </div>

                    <div class="flex items-center justify-end space-x-3 pt-2">
                        <button type="button" wire:click="$set('isImportModalOpen', false)" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold transition">
                            Cancel
                        </button>
    ...
    @if($isCreateModalOpen)
        <div class="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 dark:bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
            <div class="bg-white border border-gray-200 text-gray-900 shadow-2xl dark:bg-slate-900 dark:border-slate-800 dark:text-white rounded-3xl max-w-xl w-full p-6 space-y-6">
                <div class="flex items-center justify-between border-b border-gray-200 dark:border-slate-800 pb-4">
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button type="button" wire:click="createBlankSchoolTemplate('landscape')" class="group text-left bg-gray-50 hover:bg-indigo-50/50 border border-gray-200 hover:border-indigo-500/50 dark:bg-slate-950 dark:hover:bg-slate-900 dark:border-slate-800 dark:hover:border-indigo-500/50 rounded-2xl p-5 transition relative overflow-hidden flex flex-col items-center justify-center text-center space-y-3">
                        ...
                        <div>
                            <span class="text-sm font-extrabold text-gray-900 group-hover:text-indigo-600 dark:text-white dark:group-hover:text-indigo-400 transition block">Landscape (Horizontal)</span>
                    ...
                    <!-- Portrait Option -->
                    <button type="button" wire:click="createBlankSchoolTemplate('portrait')" class="group text-left bg-gray-50 hover:bg-indigo-50/50 border border-gray-200 hover:border-indigo-500/50 dark:bg-slate-950 dark:hover:bg-slate-900 dark:border-slate-800 dark:hover:border-indigo-500/50 rounded-2xl p-5 transition relative overflow-hidden flex flex-col items-center justify-center text-center space-y-3">
                        ...
                        <div>
                            <span class="text-sm font-extrabold text-gray-900 group-hover:text-indigo-600 dark:text-white dark:group-hover:text-indigo-400 transition block">Portrait (Vertical)</span>
                ...
                <div class="flex items-center justify-end border-t border-gray-200 dark:border-slate-800 pt-4">
                    <button type="button" wire:click="$set('isCreateModalOpen', false)" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold transition">
                        Cancel
                    </button>
                </div>
            </div>
