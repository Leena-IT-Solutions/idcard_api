            ...
            <div class="bg-white border border-slate-200/80 rounded-3xl shadow-xl shadow-slate-200/40 p-5 space-y-4">
                ...
                <div class="flex items-center bg-slate-100/90 p-1.5 rounded-2xl border border-slate-200/80 gap-1">
                    <button type="button" 
                        ...
                        class="flex-1 py-2 text-center text-xs rounded-xl transition flex items-center justify-center space-x-1.5"
                    >
                        <span>📑</span>
                        <span class="truncate">Layers & Assets</span>
                    </button>
                    ...
                    <button type="button" 
                        ...
                        class="flex-1 py-2 text-center text-xs rounded-xl transition flex items-center justify-center space-x-1.5 relative"
                    >
                        <span>🎛️</span>
                        <span class="truncate max-w-[130px]">
                            @if($selectedLayerIndex !== null && isset($layers[$selectedLayerIndex]))
                                {{ $layers[$selectedLayerIndex]['label'] ?? 'Element Controls' }}
                            @else
                                Element Controls
                            @endif
                        </span>
                ...
                <div x-show="activeInspectorTab === 'layers'" x-transition:enter="transition ease-out duration-150 transform opacity-0 scale-95" class="space-y-4">
                    <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                        ...
                        <div class="flex items-center space-x-1.5">
                            ...
                            <button type="button" wire:click="addPhotoLayer" class="px-2.5 py-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-bold transition flex items-center shadow-md shadow-amber-600/20">
                                + Photo
                            </button>
                            <button type="button" wire:click="addLogoLayer" class="px-2.5 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl text-xs font-bold transition flex items-center border border-indigo-200">
                                + Logo
                            </button>
